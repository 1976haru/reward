...
export const cosmeticFalseAdDefinition: ModuleDefinition = {
  ...
  agencyConfigPath: "src/modules/cosmetic-false-ad/agency_config.json",
  reportTemplatePath: "src/modules/cosmetic-false-ad/report_template.md",
  ...
  ui: {
    ...
    guide: {
      ...
      caution: "키워드 룰셋·신고서 초안 템플릿·증거 패키지·신고처 안내가 연결된 3차 확장 모듈입니다. 자동 신고는 하지 않으며, 실제 신고는 사람이 공식 창구에서 직접 제출합니다. 미백·주름개선·자외선차단 등 인정된 기능성 범위 표현은 사람이 검토합니다."
    }
  }
};

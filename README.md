...
- 3차 쉬운 확장: **화장품 온라인 허위·과대광고 탐지**(`cosmetic_false_ad`) — 스코프 문서 [`docs/cosmetic_false_ad_scope.md`](./docs/cosmetic_false_ad_scope.md)와 키워드 룰셋이 준비되었습니다. 건강기능식품·일반식품 모듈을 대체하지 않으며, 신고서 템플릿·agency_config·샘플 E2E 테스트는 다음 단계입니다.
